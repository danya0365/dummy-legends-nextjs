...
- ⚠️ ยังไม่คำนวณ x2/x4 multiplier สำหรับรูปแบบน็อกพิเศษในสรุปผลคะแนน
...
1. **เพิ่มโบนัสน็อกพิเศษ** (น็อกมืด/น็อกสี/น็อกมืดสี)
   - ตรวจเงื่อนไขไม่เคยเกิด + ไพ่ชุดเดียวกันทั้งหมด
   - บันทึก `game_score_events` เป็น `dark_knock_bonus`, `color_knock_bonus`, `dark_color_knock_bonus`
   - คำนวณ multiplier x2/x4 ในสรุปคะแนน
