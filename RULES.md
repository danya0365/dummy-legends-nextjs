...
### การเก็บไพ่จากกองทิ้ง

- ผู้เล่นสามารถเลือกไพ่ใบใดก็ได้ในกองทิ้ง (ไม่จำกัดเฉพาะใบบนสุด) เพื่อทำให้ชุดเกิดสมบูรณ์ในเทิร์นปัจจุบัน
- เมื่อเลือกไพ่เป้าหมาย จะต้องหยิบไพ่ตั้งแต่ใบบนสุดลงมาจนถึงใบที่เลือกทั้งหมดขึ้นมือ แล้วใช้ร่วมกับไพ่ในมือเพื่อเกิดทันที
- หากไม่สามารถจัดชุดเกิดได้หลังเก็บ ต้องจั่วจากกองจั่วตามปกติ (ระบบไม่อนุญาตให้เก็บกองทิ้งโดยไม่เกิด)
- การเก็บจากกองทิ้งช่วยแก้สถานการณ์เร่งด่วน เช่น เติมชุดเรียง/ตอง หรือกันไม่ให้คู่แข่งได้ไพ่ใบสำคัญ
...
- **ทิ้งมี่:** -50 แต้ม (ทิ้งไพ่ที่ตรงกับชุดบนโต๊ะจนสามารถฝากได้ ถือว่าทิ้งผิดและถูกหักทันที)
- **ทิ้งปี้หัว:** -50 แต้ม (ทิ้งไพ่ที่เกิดกับหัวได้ในรอบนั้น)
- **ทิ้งเต็ม:** -50 แต้ม (ทิ้งไพ่ครบชุดเรียงหรือชุดตองลงกองทิ้ง ถือว่าทำผิดกติกาและถูกหักทันที)
- **ทิ้งปี้สเปโต:** -50 แต้ม (ทิ้งไพ่ที่ทำให้ผู้เล่นถัดไปใช้สเปโต (2♣ หรือ Q♠) มารวมกับไพ่ที่ทิ้งแล้วเกิดได้ทันที)
