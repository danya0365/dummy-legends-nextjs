...
export const DUMMY_RULES_CONTENT: DummyRulesContent = {
  ...
  highlights: [
    ...
    },
    {
      ...
      description:
        "เลือกไพ่ใบใดก็ได้ในกองทิ้งแทนการจั่ว แล้วต้องหยิบไพ่ตั้งแต่ใบบนสุดลงมาถึงใบที่เลือกทั้งหมดขึ้นมือเพื่อใช้เกิดทันทีในเทิร์นเดียว",
      extraNotes:
    ...
    },
    {
      ...
      title: "เก็บหัว",
      description:
        "การเก็บหัว (ไพ่ใบบนสุดของกองทิ้ง) มารวมกับไพ่ในมือจนเกิดชุดสำเร็จ จะได้โบนัส +50 แต้ม และถ้าหัวเป็นสเปโตจะได้โบนัสสเปโตเพิ่มอีก +50 แต้ม",
    },
    {
      id: "deposit",
      title: "การฝาก",
    ...
    positive: [
      {
        id: "head-points",
        title: "ไพ่หัว",
        description: "เก็บหัวจากกองทิ้งแล้วเกิดสำเร็จในเทิร์นเดียว",
        points: "+50 แต้ม",
      },
      {
        id: "head-spe-to-points",
        title: "ไพ่หัวเป็นสเปโต",
        description: "หัวเป็น 2♣ หรือ Q♠ จะได้รับโบนัสสเปโตเพิ่มเติม",
        points: "+50 แต้ม (เพิ่มเติมจากโบนัสหัว)",
      },
      {
        id: "spe-to-meld",
