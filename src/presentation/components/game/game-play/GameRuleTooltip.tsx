...
export const GAME_RULE_TOOLTIPS = {
  ...
  discardPenalty: {
    title: "โทษการทิ้งไพ่",
    description:
      "ทิ้งไพ่ที่เปิดโอกาสให้คู่แข่งฝาก เกิด หรือน็อก หรือทิ้งชุดสมบูรณ์ลงกอง จะถูกหัก -50 แต้ม",
    examples: [
      "ทิ้งมี่: ทิ้งไพ่ที่เข้าชุดบนโต๊ะจนฝากได้ทันที (-50)",
      "ทิ้งปี้หัว: เปิดโอกาสให้เกิดรวมกับหัว (-50)",
      "ทิ้งเต็ม: ทิ้งชุดเรียงหรือชุดตองครบทั้งชุดลงกอง (-50)",
      "ทิ้งปี้สเปโต: คนถัดไปใช้สเปโตมารวมกับไพ่ที่เราทิ้งได้ทันที (-50)",
  ...
  validation: {
    ...
    description: "ระบบเตือนเมื่อคุณพยายามทำการเล่นที่ผิดกติกาหรือเสี่ยงโดนโทษ",
    examples: [
