  ...
  return (
    <div className="space-y-4">
      ...
      <RuleSection
        ...
        items={[
          "ห้ามทิ้งไพ่ที่เข้าชุดเรียงหรือชุดตองบนโต๊ะจนฝากได้เลย",
          "เกิดเหตุจะถูกหัก -50 แต้มทันที",
          "ระบบจะเตือนเมื่อไพ่ที่เลือกเสี่ยงเป็นทิ้งมี่",
        ]}
        penalty="-50 แต้ม"
      />
      ...
      <RuleSection
        ...
        description="ทิ้งไพ่ครบชุดเรียงหรือชุดตองลงกองทิ้ง ถือว่าทำผิดกติกาและจะถูกหักทันที"
        items={[
          "ห้ามทิ้งไพ่ที่จัดเป็นชุดเรียงหรือชุดตองครบทั้งชุดลงกอง",
          "ถือเป็นการทิ้งเต็มและจะถูกหัก -50 แต้มทันที",
          "ระบบจะเตือนเมื่อเลือกไพ่ที่เข้าข่ายทิ้งเต็ม",
        ]}
        penalty="-50 แต้ม"
      />
      ...
      <RuleSection
        icon={<AlertCircle className="w-5 h-5 text-red-600" />}
        title="ทิ้งปี้สเปโต"
        description="ทิ้งไพ่ที่เปิดทางให้ผู้เล่นถัดไปใช้สเปโต (2♣ หรือ Q♠) มารวมกับไพ่ที่เราทิ้งได้ทันที"
        items={[
          "สเปโตสามารถเติมเต็มชุดเรียงหรือตองได้",
          "เมื่อทำให้คู่แข่งใช้สเปโตเกิดหรือฝากได้ทันที เราจะถูกหัก -50 แต้ม",
          "ระบบจะเตือนเมื่อไพ่ที่ทิ้งเสี่ยงโดนสเปโต",
        ]}
        penalty="-50 แต้ม"
      />
